...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/swp-song/SwpModel.git", :commit => "4e0d70e289d6ac5899cdc8dec2fd9d0175d5fe06" }
  ...
  s.source_files  = "SwpModel", "SwpModel/**/*.{h,m}"
